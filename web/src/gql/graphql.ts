...
export type GetProductsQuery = { __typename?: 'Query', getProducts: { __typename?: 'ProductConnection', total: number, data: Array<{ __typename?: 'Product', id: string, name: string, description?: string | null, content?: string | null, createdAt: any, updatedAt: any }> } };
